...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UILabel *labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(YH_Edges, 0, zScreenWidth-YH_Edges*2, rowHeight)];
        labelTitle.tag = 101;
...
- (void)initSubViews{
    ...
    self.tableview = [[UITableView alloc] initWithFrame:CGRectMake(0,zScreenHeight + tableviewH, zScreenWidth, tableviewH) style:UITableViewStylePlain];
    ...
    //2.背景view
    self.backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, zScreenHeight, zScreenWidth, zScreenHeight)];
    self.backgroundView.backgroundColor = [[UIColor colorHexString:@"C3C4C5"] colorWithAlphaComponent:0.5];
...
- (void)showViewAnimation {
    ...
    self.backgroundView.frame = CGRectMake(0, 0, zScreenWidth, zScreenHeight);
...
- (void)dismissViewAnimation {
    ...
    self.backgroundView.frame = CGRectMake(0, zScreenHeight, zScreenWidth, zScreenHeight);
