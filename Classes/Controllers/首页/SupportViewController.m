...
- (void)load{
    [HTTPRequest postWithURL:@"api/activity/getlistbytype" method:@"POST" params: @{@"pageNum":@"0",@"pageSize":@"10",@"activityType":@"0"} ProgressHUD:self.Hud controller:self response:^(id json) {
        NSLog(@"first success%@",json);
        
        NSDictionary *dic = [NSDictionary dictionaryWithDictionary:json];
        datadict = [dic objectForKey:@"data"];
        activityarr = [NSMutableArray arrayWithArray:[datadict objectForKey:@"list"]];
