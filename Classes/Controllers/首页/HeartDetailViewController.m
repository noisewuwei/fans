...
@interface HeartDetailViewController ()<UIWebViewDelegate,ChooseRankDelegate>{
    UIWebView *webview;
...
@implementation HeartDetailViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSString *url = [NSString stringWithFormat:@"http://192.168.0.106:8888/app6.html?activityId=%@&token=%@",_str,[dic objectForKey:@"token"]];
