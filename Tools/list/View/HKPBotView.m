...
- (void)setup{
    ...
    [btnComment setTitleColor:[UIColor colorHexString:@"383838"] forState:UIControlStateNormal];
    [btnComment setImage:[UIImage imageNamed:@"icon_reward"] forState:UIControlStateNormal];
    ...
    [btnLike setTitleColor:[UIColor colorHexString:@"383838"] forState:UIControlStateNormal];
    [btnLike setTitleColor:[UIColor colorHexString:@"383838"] forState:UIControlStateSelected];
    [btnLike setImage:[UIImage imageNamed:@"icon_share"] forState:UIControlStateNormal];
    ...
    [btnShare setTitle:@"0" forState:UIControlStateNormal];
    [btnShare setTitleColor:[UIColor colorHexString:@"383838"] forState:UIControlStateNormal];
    [btnShare setImage:[UIImage imageNamed:@"icon_share"] forState:UIControlStateNormal];
    [btnShare setImage:[UIImage imageNamed:@"icon_comment"] forState:UIControlStateNormal];
