...
- (void)load{
    [HTTPRequest postWithURL:@"api/activity/getlistbytype" method:@"POST" params: @{@"pageNum":@"0",@"pageSize":@"10",@"activityType":@"2"} ProgressHUD:self.Hud controller:self response:^(id json) {
