...
@interface PersonStationViewController ()<UITableViewDelegate,UITableViewDataSource,CellForWorkGroupDelegate,CellForWorkGroupRepostDelegate>{
...
@implementation PersonStationViewController
