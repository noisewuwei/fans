...
@interface FansDrawViewController ()<UITableViewDelegate,UITableViewDataSource,CellForWorkGroupDelegate,CellForWorkGroupRepostDelegate>{
...
@implementation FansDrawViewController
