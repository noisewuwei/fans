...
@interface BigBarViewController ()<UITableViewDelegate,UITableViewDataSource,CellForWorkGroupDelegate,CellForWorkGroupRepostDelegate>{
...
@implementation BigBarViewController
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    UIView *backview = [[UIView alloc]initWithFrame:CGRectMake(0, 0, zScreenWidth, 156)];
    backview.backgroundColor = [UIColor colorHexString:@"ececec"];
    [headerView addSubview:backview];
    
    UIView *whiteview = [[UIView alloc]initWithFrame:CGRectMake(0, 1, zScreenWidth, 156-1-10)];
    whiteview.backgroundColor = [UIColor whiteColor];
    [backview addSubview:whiteview];
    
    UILabel *titleLab = [[UILabel alloc]initWithFrame:CGRectMake(15, 18, 100, 20)];
    titleLab.textAlignment = NSTextAlignmentLeft;
    titleLab.textColor = [UIColor colorHexString:@"383838"];
    titleLab.font = [UIFont systemFontOfSize:14 weight:UIFontWeightRegular];
    titleLab.text = @"热门大吧";
    [whiteview addSubview:titleLab];
    
    UIButton *btn1 = [[UIButton alloc]initWithFrame:CGRectMake(15, 60, 130, 29)];
    btn1.layer.masksToBounds = YES;
    btn1.layer.cornerRadius = 14.5;
    [btn1 setBackgroundColor:[UIColor colorHexString:@"f2f2f2"]];
    btn1.tag = 0;
    btn1.titleLabel.font = [UIFont systemFontOfSize:12 weight:UIFontWeightRegular];
    [btn1 setTitleColor:[UIColor colorHexString:@"777777"] forState:UIControlStateNormal];
    [whiteview addSubview:btn1];
    
    UIButton *btn2 = [[UIButton alloc]initWithFrame:CGRectMake(15+130+11, 60, 130, 29)];
    btn2.layer.masksToBounds = YES;
    btn2.layer.cornerRadius = 14.5;
    [btn2 setBackgroundColor:[UIColor colorHexString:@"f2f2f2"]];
    btn2.tag = 0;
    btn2.titleLabel.font = [UIFont systemFontOfSize:12 weight:UIFontWeightRegular];
    [btn2 setTitleColor:[UIColor colorHexString:@"777777"] forState:UIControlStateNormal];
    [whiteview addSubview:btn2];
    
    UIButton *btn3 = [[UIButton alloc]initWithFrame:CGRectMake(15+20, 60+29+15, 130, 29)];
    btn3.layer.masksToBounds = YES;
    btn3.layer.cornerRadius = 14.5;
    [btn3 setBackgroundColor:[UIColor colorHexString:@"f2f2f2"]];
    btn3.tag = 0;
    btn3.titleLabel.font = [UIFont systemFontOfSize:12 weight:UIFontWeightRegular];
    [btn3 setTitleColor:[UIColor colorHexString:@"777777"] forState:UIControlStateNormal];
    [whiteview addSubview:btn3];
    
    UIButton *btn4 = [[UIButton alloc]initWithFrame:CGRectMake(15+130+11+20, 60+29+15, 130, 29)];
    btn4.layer.masksToBounds = YES;
    btn4.layer.cornerRadius = 14.5;
    [btn4 setBackgroundColor:[UIColor colorHexString:@"f2f2f2"]];
    btn4.tag = 0;
    btn4.titleLabel.font = [UIFont systemFontOfSize:12 weight:UIFontWeightRegular];
    [btn4 setTitleColor:[UIColor colorHexString:@"777777"] forState:UIControlStateNormal];
    [whiteview addSubview:btn4];
    
    if (array.count > 0) {
        [btn1 setTitle:[array[0] objectForKey:@"name"] forState:UIControlStateNormal];
        [btn2 setTitle:[array[1] objectForKey:@"name"] forState:UIControlStateNormal];
        [btn3 setTitle:[array[2] objectForKey:@"name"] forState:UIControlStateNormal];
        [btn4 setTitle:[array[3] objectForKey:@"name"] forState:UIControlStateNormal];
    }
