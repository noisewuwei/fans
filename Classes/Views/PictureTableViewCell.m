...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self=[super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        UIView *line2 = [[UIView alloc]initWithFrame:CGRectMake(0, 50+189, zScreenWidth, 10)];
        line2.backgroundColor = [UIColor colorHexString:@"ececec"];
        [self addSubview:line2];
        
        _Img1 = [[UIButton alloc]initWithFrame:CGRectMake(15, 50+10, zScreenWidth/2-15-3.5, 169)];
        _Img1.contentMode = UIViewContentModeScaleToFill;
        [self addSubview:_Img1];
        
        _Img1right = [[UIButton alloc]initWithFrame:CGRectMake(zScreenWidth/2+3.5, 50+10, zScreenWidth/2-15-3.5, 169)];
        _Img1right.contentMode = UIViewContentModeScaleToFill;
        [self addSubview:_Img1right];
        
        _Img2 = [[UIButton alloc]initWithFrame:CGRectMake(zScreenWidth/2+3.5, 50+10, (zScreenWidth/2-15-3.5-7)/2, 81)];
        _Img2.contentMode = UIViewContentModeScaleToFill;
        [self addSubview:_Img2];
        
        _Img3 = [[UIButton alloc]initWithFrame:CGRectMake(zScreenWidth/2+3.5+(zScreenWidth/2-15-3.5-7)/2+7, 50+10, (zScreenWidth/2-15-3.5-7)/2, 81)];
        _Img3.contentMode = UIViewContentModeScaleToFill;
        [self addSubview:_Img3];
        
        _Img4 = [[UIButton alloc]initWithFrame:CGRectMake(zScreenWidth/2+3.5, 50+10+81+7, (zScreenWidth/2-15-3.5-7)/2, 81)];
        _Img4.contentMode = UIViewContentModeScaleToFill;
        [self addSubview:_Img4];
        
        _Img5 = [[UIButton alloc]initWithFrame:CGRectMake(zScreenWidth/2+3.5+(zScreenWidth/2-15-3.5-7)/2+7, 50+10+81+7, (zScreenWidth/2-15-3.5-7)/2, 81)];
