...
-(void)creatUI{
    ...
    //半透明视图
    alphaView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, zScreenWidth, zScreenHeight)];
    alphaView.backgroundColor = [UIColor blackColor];
    alphaView.alpha = 0.4;
    [self addSubview:alphaView];
    
    //装载商品信息的视图
    whiteView = [[UIView alloc] initWithFrame:CGRectMake(0, 280, zScreenWidth, zScreenHeight-280)];
    whiteView.backgroundColor = [UIColor whiteColor];
    [self addSubview:whiteView];
    
    //商品图片
    headImage = [[UIImageView alloc] initWithFrame:CGRectMake(15, 14, 100, 100)];
    [whiteView addSubview:headImage];
    
    cancelBtn= [UIButton buttonWithType:UIButtonTypeCustom];
    cancelBtn.frame = CGRectMake(zScreenWidth-40, 10, 25, 25);
    [cancelBtn setBackgroundImage:[UIImage imageNamed:@"close"] forState:0];
    [whiteView addSubview:cancelBtn];
    
    
    //商品价格
    LB_price = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(headImage.frame)+20, 50, 150, 20)];
    LB_price.text = @"¥100";
    LB_price.textColor = [UIColor colorHexString:@"fd7e82"];
...
//    [whiteView addSubview:LB_showSales];
    ...
    //分界线
    LB_line = [[UILabel alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(headImage.frame)+10, zScreenWidth-30, 0.5)];
    LB_line.backgroundColor = [UIColor colorHexString:@"ececec"];
    [whiteView addSubview:LB_line];
    
    //加入购物车按钮
    addBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    addBtn.frame = CGRectMake(0, whiteView.frame.size.height-40, whiteView.frame.size.width/2, 40);
...
//    [whiteView addSubview:addBtn];
    ...
    buyBtn.frame = CGRectMake(0,  whiteView.frame.size.height-49, whiteView.frame.size.width, 49);
    [buyBtn setBackgroundColor:[UIColor colorHexString:@"fedb43"]];
    [buyBtn setTitleColor:[UIColor colorHexString:@"383838"] forState:0];
    ...
    stockBtn.frame = CGRectMake(0,  whiteView.frame.size.height-40, zScreenWidth, 40);
    ...
    mainscrollview = [[UIScrollView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(headImage.frame)+10, zScreenWidth, whiteView.frame.size.height-CGRectGetMaxY(headImage.frame)+10-60)];
