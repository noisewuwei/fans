...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [HTTPRequest postWithURL:@"api/star/picture/getpicturelistbytype" method:@"POST" params: @{@"starId":_starid,@"type":@"0"} ProgressHUD:self.Hud controller:self response:^(id json) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PictureTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    ...
    if (!cell) {
        ...
        cell = [[PictureTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
